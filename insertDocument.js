...
//BAGIAN INI MENCETAK INFORMASI DARI ObjectID() // Mencetak ObjectId yang baru dibuat ke konsol.
console.log(id);
...
async function main() {
  try {
    ...
    // Menggunakan 'await' untuk menghubungkan ke server MongoDB. await
    client.connect();
